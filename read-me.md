-> After downloading the automation zip folder, follow the below steps to run the spring boot application which has the required Api's for the home automation system.
